...
`endif
  ...
  assign ls_is_addr_inject_v      = tmo_injection_req_made | pref_injection_req_made;
  ...
  assign  tmo_req_suppress_m0 =   ( (any_req_waiting_cnt_saturated_q & ~round_robin_select_q[`RV_BC_LS_INJ_RR_TMO] ) | precommit_reject_saturated ) 
                                & ~(ls_16_of_64_tick_tock & (~(spe_tlb_lookup_req | tbe_tlb_lookup_req) |  toggle_favors_tmo_q));  
